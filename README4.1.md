...
### **2. 01 Solución de caso con Mongo, redis, node, express, mongoose, replicaset**
...
**Codigo .env**
```env
MONGO_URI=mongodb://172.20.0.3:27017,172.20.0.4:27017,172.20.0.5:27017,172.20.0.6:27017/tienda_online?replicaSet=replica01
REDIS_HOST=redis
REDIS_PORT=6379
PORT=3000
```

## **Codigo de la API, funcionamiento, mongoose,express, etc.**
